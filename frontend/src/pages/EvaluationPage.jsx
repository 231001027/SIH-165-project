              ...
              <tbody>
                {Object.entries(sif.per_class).map(([cls, m]) => (
                  <tr key={cls} className="border-b border-line/70">
                    <td className="py-1.5 font-bold text-ink_text-primary">{cls}</td>
                    <td className="py-1.5 text-right tabular-nums">{m.precision}</td>
                    <td className="py-1.5 text-right tabular-nums">{m.recall}</td>
                    <td className="py-1.5 text-right tabular-nums">{m.f1}</td>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-line text-left text-[10.5px] font-bold uppercase tracking-wide text-ink_text-muted">
                  ...
                  <th className="py-1.5 text-right">Accuracy</th>
                  <th className="py-1.5 text-right">Support</th>
                </tr>
              </thead>
              <tbody>
